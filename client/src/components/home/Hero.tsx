...
export default function Hero() {
  ...
  return (
    <section 
      ref={parallaxRef}
      className="relative h-[85vh] min-h-[540px] sm:h-[90vh] sm:min-h-[600px] flex items-center justify-center overflow-hidden bg-[#0c1e28]"
    ...
    >
      ...
      {!imageLoaded && (
        <div className="absolute inset-0 bg-gradient-to-b from-[#0c1e28] via-[#0c1e28] to-[#04121a]">
