...
export default function Footer() {
  ...
  return (
    <footer 
      className="bg-[#0e1a27] border-t border-white/10 mt-auto relative"
      role="contentinfo"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14 sm:py-16 lg:py-20">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 sm:gap-12 lg:gap-16">
          ...
          <div className="space-y-5">
            <h3 className="text-base font-semibold text-white font-heading tracking-wider uppercase">FROSTLINE AS</h3>
            <p className="text-sm text-white/60 leading-relaxed max-w-xs">
              {t.footer.companyDescription}
            </p>
            <address className="text-sm text-white/55 space-y-1.5 not-italic">
              <p className="font-medium text-white/75">Org.nr: 936 520 553</p>
              <p>Kompaniveien 4</p>
          ...
          <nav className="space-y-5" aria-label="Quick links">
            <h3 className="text-base font-semibold text-white tracking-wide">{t.footer.quickLinks}</h3>
            <ul className="flex flex-col gap-2.5">
              <li>
                <Link href="/services" data-testid="footer-link-services">
                  <span className="text-sm text-white/60 hover:text-white cursor-pointer transition-all duration-200 hover:translate-x-1 inline-block">
                    {t.navbar.services}
                  </span>
                </Link>
              </li>
          ...
          {/* Contact Info */}
          <div className="space-y-5">
            <h3 className="text-base font-semibold text-white tracking-wide">{t.navbar.contact}</h3>
            <div className="space-y-4">
              ...
              >
                <span className="w-9 h-9 rounded-lg bg-white/10 flex items-center justify-center transition-all duration-200 group-hover:bg-white/15 group-hover:scale-105">
                  <Mail className="w-4 h-4 text-white/80" aria-hidden="true" />
                </span>
              ...
              >
                <span className="w-9 h-9 rounded-lg bg-white/10 flex items-center justify-center transition-all duration-200 group-hover:bg-white/15 group-hover:scale-105">
                  <Phone className="w-4 h-4 text-white/80" aria-hidden="true" />
                </span>
                <span className="text-white/80 group-hover:text-white transition-colors duration-200 font-medium">
                  {t.contact.phoneNumber}
                </span>
              </a>
              <p className="text-sm text-white/65 font-medium mt-5 pt-4 border-t border-white/10" data-testid="text-quick-response">
          ...
          <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
            ...
            <nav className="flex gap-6" aria-label="Legal links">
              <Link href="/terms" data-testid="footer-bottom-link-terms">
                <span className="text-sm text-white/45 hover:text-white cursor-pointer transition-colors duration-200">
                  {t.footer.terms}
                </span>
              </Link>
