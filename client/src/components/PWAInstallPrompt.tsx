...
export default function PWAInstallPrompt() {
  ...
  return (
    ...
    >
      <div className="relative bg-card/95 backdrop-blur-xl backdrop-saturate-150 border border-border/40 rounded-2xl shadow-[0_12px_40px_-4px_rgba(14,42,71,0.15)] p-5 overflow-hidden">
