...
export default function ServiceCard({ icon, title, description }: ServiceCardProps) {
  return (
    <Card className="p-5 sm:p-6 lg:p-7 cursor-default group bg-white dark:bg-card border-border/20 dark:border-border/30 hover:border-primary/25 rounded-2xl shadow-[0_4px_20px_-4px_rgba(13,41,37,0.08),0_1px_3px_rgba(13,41,37,0.04)] dark:shadow-[0_4px_20px_-4px_rgba(0,0,0,0.3),0_1px_3px_rgba(0,0,0,0.2)] hover:shadow-[0_8px_30px_-4px_rgba(13,41,37,0.12),0_2px_6px_rgba(13,41,37,0.06)] dark:hover:shadow-[0_8px_30px_-4px_rgba(0,0,0,0.4),0_2px_6px_rgba(0,0,0,0.25)] transition-all duration-[280ms] ease-[cubic-bezier(0.22,1,0.36,1)] hover:translate-y-[-2px]">
      <div className="flex flex-col items-start gap-3 sm:gap-4">
        <div className="w-14 h-14 sm:w-16 sm:h-16 rounded-xl overflow-hidden flex-shrink-0 transition-all duration-[280ms] ease-[cubic-bezier(0.22,1,0.36,1)] group-hover:translate-y-[-2px] shadow-[0_2px_8px_rgba(13,41,37,0.08)] dark:shadow-[0_2px_8px_rgba(0,0,0,0.3)] bg-[#f7f9fc] dark:bg-muted/30 will-change-transform">
          <img
            src={icon}
